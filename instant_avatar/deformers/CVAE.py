...
class CVAE(nn.Module):
    ...
    def __init__(self, feature_size, y_input_size, latent_size):
        ...
        self.fc_e1 = nn.Linear(feature_size + y_input_size, 128)
        self.fc_e2 = nn.Linear(128, 128)

        self.fc_mu = nn.Linear(128, latent_size)
        self.fc_log_std = nn.Linear(128, latent_size)

        self.fc_d1 = nn.Linear(latent_size + y_input_size, 128)
        self.fc_d2 = nn.Linear(128, 128)

        self.fc_embed = nn.Linear(128, 128)
        self.fc_res = nn.Linear(128, y_input_size*13)
    ...
    def decode(self, z, y):
        ...
        # res = torch.sigmoid(self.fc_res(h4))
